...
#define TLB_OV_PROTECT			4.20	// 单体过压保护电压  电池饱和了    AD的精度要有0.01 v 
#define TLB_OV_RELIEVE			4.18	// 单体过压恢复电压  不在饱和状态了
#define TLB_UV_PROTECT			3.10	// 单体欠压保护电压  电池最低的电压，没电了
#define TLB_UV_RELIEVE			3.15	// 单体欠压恢复电压  不再是馈电状态
#define TLB_SHUTDOWN_VOLTAGE	3.08	// 自动关机电压      强制关机
#define TLB_BALANCE_VOLTAGE		3.30	// 均衡起始电压      是否开启均衡功能 高于开， 低于关；
